...
#ifndef DYNAMICDRIFTCORRECTIONACTION_H_
#define DYNAMICDRIFTCORRECTIONACTION_H_

#include "src/State/Web/Tab/Pipelines/Actions/Action.h"
#include "src/Utils/LerpValue.h"
#include <vector>

class DynamicDriftCorrectionAction : public Action
{
public:

    // Constructor
	DynamicDriftCorrectionAction(TabInteractionInterface* pTab, bool doDimming = true);
...
#endif // DYNAMICDRIFTCORRECTIONACTION_H_
